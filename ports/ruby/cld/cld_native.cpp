...
static VALUE t_detect_language(VALUE self, VALUE text, VALUE options)
{
    ...
    bool do_pick_summary_language = !rb_hash_aref(options, SYMBOL_NAMED("no_summary"));
   ...
   return t_build_detection_result(lang, is_reliable, language3, normalized_score3);
}
